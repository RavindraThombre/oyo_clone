      ...
      <div className="p-5">
        ...
        <div className="grid grid-cols-5 my-5 mx-20">
          <input
            type="text"
            placeholder="Search..."
            className="w-16/12 h-16 outline-none px-3 text-lg border-r-2 border-gray-400 col-span-2"
          />
          <input
            type="date"
            placeholder="Search..."
          ...
          <button
            type="submit"
            className="h-16 px-3 py-2 col-span-1 w-72 bg-green-400 hover:cursor-pointer hover:bg-green-600 text-white text-xl"
          >
            Search
          </button>
        </div>
